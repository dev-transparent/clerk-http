...
# Unit tests for Clerk::JWKSEcdsaPublicKey
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Clerk::JWKSEcdsaPublicKey do

  describe "test an instance of JWKSEcdsaPublicKey" do
    it "should create an instance of JWKSEcdsaPublicKey" do
      #instance = Clerk::JWKSEcdsaPublicKey.new
      #expect(instance).to be_instance_of(Clerk::JWKSEcdsaPublicKey)
    end
  end
