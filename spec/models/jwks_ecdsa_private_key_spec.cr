...
# Unit tests for Clerk::JWKSEcdsaPrivateKey
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Clerk::JWKSEcdsaPrivateKey do

  describe "test an instance of JWKSEcdsaPrivateKey" do
    it "should create an instance of JWKSEcdsaPrivateKey" do
      #instance = Clerk::JWKSEcdsaPrivateKey.new
      #expect(instance).to be_instance_of(Clerk::JWKSEcdsaPrivateKey)
    end
  end
