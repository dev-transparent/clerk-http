...
# Unit tests for Clerk::OrganizationMembership
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Clerk::OrganizationMembership do

  describe "test an instance of OrganizationMembership" do
    it "should create an instance of OrganizationMembership" do
      #instance = Clerk::OrganizationMembership.new
      #expect(instance).to be_instance_of(Clerk::OrganizationMembership)
    end
  end
