...
# Unit tests for Clerk::ToggleTemplateDeliveryRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Clerk::ToggleTemplateDeliveryRequest do
  ...
  describe "test an instance of ToggleTemplateDeliveryRequest" do
    it "should create an instance of ToggleTemplateDeliveryRequest" do
      #instance = Clerk::ToggleTemplateDeliveryRequest.new
      #expect(instance).to be_instance_of(Clerk::ToggleTemplateDeliveryRequest)
    end
  end
