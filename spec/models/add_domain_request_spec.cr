...
# Unit tests for Clerk::AddDomainRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Clerk::AddDomainRequest do

  describe "test an instance of AddDomainRequest" do
    it "should create an instance of AddDomainRequest" do
      #instance = Clerk::AddDomainRequest.new
      #expect(instance).to be_instance_of(Clerk::AddDomainRequest)
    end
  end
