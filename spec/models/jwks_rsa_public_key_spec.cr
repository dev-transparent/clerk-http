...
# Unit tests for Clerk::JWKSRsaPublicKey
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Clerk::JWKSRsaPublicKey do

  describe "test an instance of JWKSRsaPublicKey" do
    it "should create an instance of JWKSRsaPublicKey" do
      #instance = Clerk::JWKSRsaPublicKey.new
      #expect(instance).to be_instance_of(Clerk::JWKSRsaPublicKey)
    end
  end
