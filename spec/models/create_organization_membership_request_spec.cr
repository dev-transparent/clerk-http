...
# Unit tests for Clerk::CreateOrganizationMembershipRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Clerk::CreateOrganizationMembershipRequest do
  ...
  describe "test an instance of CreateOrganizationMembershipRequest" do
    it "should create an instance of CreateOrganizationMembershipRequest" do
      #instance = Clerk::CreateOrganizationMembershipRequest.new
      #expect(instance).to be_instance_of(Clerk::CreateOrganizationMembershipRequest)
    end
  end
