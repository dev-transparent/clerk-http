...
# Unit tests for Clerk::JWKSSymmetricKey
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Clerk::JWKSSymmetricKey do

  describe "test an instance of JWKSSymmetricKey" do
    it "should create an instance of JWKSSymmetricKey" do
      #instance = Clerk::JWKSSymmetricKey.new
      #expect(instance).to be_instance_of(Clerk::JWKSSymmetricKey)
    end
  end
