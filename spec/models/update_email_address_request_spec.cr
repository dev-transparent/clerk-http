...
# Unit tests for Clerk::UpdateEmailAddressRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Clerk::UpdateEmailAddressRequest do

  describe "test an instance of UpdateEmailAddressRequest" do
    it "should create an instance of UpdateEmailAddressRequest" do
      #instance = Clerk::UpdateEmailAddressRequest.new
      #expect(instance).to be_instance_of(Clerk::UpdateEmailAddressRequest)
    end
  end
