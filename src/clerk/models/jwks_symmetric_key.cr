...
module Clerk
  class JWKSSymmetricKey
    ...
    @[JSON::Field(key: "k", type: String, nillable: false, emit_null: false)]
    property k : String
    ...
    def initialize(@kid : String, @alg : String, @use : String, @kty : String, @k : String, @x5c : Array(String)?, @x5t : String?, @x5t_s256 : String?, @x5u : String?)
    end
