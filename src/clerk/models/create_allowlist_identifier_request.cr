...
module Clerk
  class CreateAllowlistIdentifierRequest
    ...
    @[JSON::Field(key: "identifier", type: String, nillable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "notify", type: Bool?, default: false, nillable: true, emit_null: false)]
    property notify : Bool?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@identifier : String, @notify : Bool?)
    end
