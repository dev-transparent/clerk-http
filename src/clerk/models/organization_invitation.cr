...
module Clerk
  ...
  class OrganizationInvitation
    ...
    def initialize(@object : String, @id : String, @email_address : String, @role : String, @role_name : String, @public_metadata : Hash(String, Object), @url : String, @expires_at : Int64, @created_at : Int64, @updated_at : Int64, @organization_id : String?, @status : String?, @private_metadata : Hash(String, Object)?)
    end
