...
module Clerk
  class Domain
    ...
    @[JSON::Field(key: "is_satellite", type: Bool, nillable: false, emit_null: false)]
    property is_satellite : Bool

    @[JSON::Field(key: "frontend_api_url", type: String, nillable: false, emit_null: false)]
    property frontend_api_url : String

    @[JSON::Field(key: "development_origin", type: String, nillable: false, emit_null: false)]
    property development_origin : String

    # Optional properties
    # Null for satellite domains. 
    @[JSON::Field(key: "accounts_portal_url", type: String?, nillable: true, emit_null: false)]
    property accounts_portal_url : String?

    @[JSON::Field(key: "proxy_url", type: String?, nillable: true, emit_null: false)]
    property proxy_url : String?

    @[JSON::Field(key: "cname_targets", type: Array(CNameTarget)?, nillable: true, emit_null: false)]
    property cname_targets : Array(CNameTarget)?
    ...
    def initialize(@object : String, @id : String, @name : String, @is_satellite : Bool, @frontend_api_url : String, @development_origin : String, @accounts_portal_url : String?, @proxy_url : String?, @cname_targets : Array(CNameTarget)?)
    end
