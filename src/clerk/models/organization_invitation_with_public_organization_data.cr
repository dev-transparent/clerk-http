...
module Clerk
  ...
  class OrganizationInvitationWithPublicOrganizationData
    ...
    @[JSON::Field(key: "role_name", type: String, nillable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "expires_at", type: Int64, nillable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "public_organization_data", type: OrganizationInvitationPublicOrganizationData?, nillable: true, emit_null: false)]
    property public_organization_data : OrganizationInvitationPublicOrganizationData?
    ...
    def initialize(@object : String, @id : String, @email_address : String, @role : String, @role_name : String, @public_metadata : Hash(String, Object), @url : String, @expires_at : Int64, @created_at : Int64, @updated_at : Int64, @organization_id : String?, @status : String?, @private_metadata : Hash(String, Object)?, @public_organization_data : OrganizationInvitationPublicOrganizationData?)
    end
