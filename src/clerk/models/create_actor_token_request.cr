...
module Clerk
  class CreateActorTokenRequest
    ...
    @[JSON::Field(key: "actor", type: CreateActorTokenRequestActor, nillable: false, emit_null: false)]
    property actor : CreateActorTokenRequestActor

    # Optional properties
    # Optional parameter to specify the life duration of the actor token in seconds. By default, the duration is 1 hour.
    @[JSON::Field(key: "expires_in_seconds", type: Int32?, default: 3600, nillable: true, emit_null: false)]
    property expires_in_seconds : Int32?
    ...
    @[JSON::Field(key: "session_max_duration_in_seconds", type: Int32?, default: 1800, nillable: true, emit_null: false)]
    property session_max_duration_in_seconds : Int32?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@user_id : String, @actor : CreateActorTokenRequestActor, @expires_in_seconds : Int32?, @session_max_duration_in_seconds : Int32?)
    end
