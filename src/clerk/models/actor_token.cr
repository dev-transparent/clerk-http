...
module Clerk
  class ActorToken
    ...
    @[JSON::Field(key: "actor", type: Object, nillable: false, emit_null: false)]
    ...
    def initialize(@object : String, @id : String, @status : String, @user_id : String, @actor : Object, @created_at : Int64, @updated_at : Int64, @token : String?, @url : String?)
    end
