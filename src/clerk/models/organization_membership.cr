...
module Clerk
  ...
  class OrganizationMembership
    ...
    @[JSON::Field(key: "permissions", type: Array(String), nillable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "organization", type: Organization, nillable: false, emit_null: false)]
    ...
    # Optional properties
    @[JSON::Field(key: "role_name", type: String?, nillable: true, emit_null: false)]
    ...
    @[JSON::Field(key: "public_user_data", type: OrganizationMembershipPublicUserData?, nillable: true, emit_null: false)]
    property public_user_data : OrganizationMembershipPublicUserData?
    ...
    def initialize(@id : String, @object : String, @role : String, @permissions : Array(String), @public_metadata : Hash(String, Object), @organization : Organization, @created_at : Int64, @updated_at : Int64, @role_name : String?, @private_metadata : Hash(String, Object)?, @public_user_data : OrganizationMembershipPublicUserData?)
    end
