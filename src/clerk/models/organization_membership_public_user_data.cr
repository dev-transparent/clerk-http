...
module Clerk
  ...
  class OrganizationMembershipPublicUserData
    ...
    @[JSON::Field(key: "profile_image_url", type: String, nillable: false, emit_null: false)]
    ...
    def initialize(@user_id : String, @first_name : String, @last_name : String, @profile_image_url : String, @image_url : String, @has_image : Bool, @identifier : String?)
    end
