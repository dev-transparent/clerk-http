...
module Clerk
  class OAuthApplicationWithSecret
    ...
    @[JSON::Field(key: "instance_id", type: String, nillable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "scopes", type: String, nillable: false, emit_null: false)]
    property scopes : String

    @[JSON::Field(key: "redirect_uris", type: Array(String), nillable: false, emit_null: false)]
    property redirect_uris : Array(String)

    # Deprecated: Use redirect_uris instead. 
    @[JSON::Field(key: "callback_url", type: String, nillable: false, emit_null: false)]
    property callback_url : String

    @[JSON::Field(key: "authorize_url", type: String, nillable: false, emit_null: false)]
    property authorize_url : String

    @[JSON::Field(key: "token_fetch_url", type: String, nillable: false, emit_null: false)]
    property token_fetch_url : String

    @[JSON::Field(key: "user_info_url", type: String, nillable: false, emit_null: false)]
    property user_info_url : String

    @[JSON::Field(key: "discovery_url", type: String, nillable: false, emit_null: false)]
    property discovery_url : String

    @[JSON::Field(key: "token_introspection_url", type: String, nillable: false, emit_null: false)]
    property token_introspection_url : String
    ...
    @[JSON::Field(key: "client_secret", type: String?, nillable: true, emit_null: false)]
    ...
    def initialize(@object : String, @id : String, @instance_id : String, @name : String, @client_id : String, @public : Bool, @scopes : String, @redirect_uris : Array(String), @callback_url : String, @authorize_url : String, @token_fetch_url : String, @user_info_url : String, @discovery_url : String, @token_introspection_url : String, @created_at : Int64, @updated_at : Int64, @client_secret : String?)
    end
