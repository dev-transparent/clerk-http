...
module Clerk
  class SessionActivityResponse
    ...
    @[JSON::Field(key: "is_mobile", type: Bool, nillable: false, emit_null: false)]
    ...
    @[JSON::Field(key: "browser_name", type: String?, nillable: true, emit_null: false)]
    property browser_name : String?

    @[JSON::Field(key: "browser_version", type: String?, nillable: true, emit_null: false)]
    ...
    def initialize(@object : String, @id : String, @is_mobile : Bool, @device_type : String?, @browser_name : String?, @browser_version : String?, @ip_address : String?, @city : String?, @country : String?)
    end
