...
module Clerk
  class CreateOrganizationRequest
    ...
    def initialize(@name : String, @created_by : String?, @private_metadata : Hash(String, Object)?, @public_metadata : Hash(String, Object)?, @slug : String?, @max_allowed_memberships : Int32?, @created_at : String?)
    end
