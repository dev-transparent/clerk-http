...
module Clerk
  class SchemasPasskey
    ...
    @[JSON::Field(key: "last_used_at", type: Int64, nillable: false, emit_null: false)]
    property last_used_at : Int64

    @[JSON::Field(key: "verification", type: SchemasPasskeyVerification, nillable: false, emit_null: false)]
    property verification : SchemasPasskeyVerification
    ...
    def initialize(@object : String, @name : String, @last_used_at : Int64, @verification : SchemasPasskeyVerification, @id : String?)
    end
