...
module Clerk
  class CreateSignInTokenRequest
    ...
    @[JSON::Field(key: "expires_in_seconds", type: Int32?, default: 2592000, nillable: true, emit_null: false)]
    property expires_in_seconds : Int32?

    # Initializes the object
    # @param [Hash] attributes Model attributes in the form of hash
    def initialize(@user_id : String, @expires_in_seconds : Int32?)
    end
    ...
    def expires_in_seconds=(expires_in_seconds)
      if !expires_in_seconds.nil? && expires_in_seconds < 1
        raise ArgumentError.new("invalid value for \"expires_in_seconds\", must be greater than or equal to 1.")
      end
