...
module Clerk
  class ProxyCheck
    ...
    @[JSON::Field(key: "last_run_at", type: Int64, nillable: false, emit_null: false)]
    property last_run_at : Int64

    @[JSON::Field(key: "proxy_url", type: String, nillable: false, emit_null: false)]
    property proxy_url : String

    @[JSON::Field(key: "successful", type: Bool, nillable: false, emit_null: false)]
    ...
    def initialize(@object : String, @id : String, @domain_id : String, @last_run_at : Int64, @proxy_url : String, @successful : Bool, @created_at : Int64, @updated_at : Int64)
    end
