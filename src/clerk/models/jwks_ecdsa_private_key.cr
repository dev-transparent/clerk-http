...
module Clerk
  class JWKSEcdsaPrivateKey
    ...
    def initialize(@kid : String, @alg : String, @use : String, @kty : String, @crv : String, @x : String, @y : String, @d : String, @x5c : Array(String)?, @x5t : String?, @x5t_s256 : String?, @x5u : String?)
    end
