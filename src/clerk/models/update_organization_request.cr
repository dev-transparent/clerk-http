...
module Clerk
  class UpdateOrganizationRequest
    ...
    def initialize(@public_metadata : Hash(String, Object)?, @private_metadata : Hash(String, Object)?, @name : String?, @slug : String?, @max_allowed_memberships : Int32?, @admin_delete_enabled : Bool?, @created_at : String?)
    end
    ...
    def max_allowed_memberships=(max_allowed_memberships)
      if !max_allowed_memberships.nil? && max_allowed_memberships < 0
        raise ArgumentError.new("invalid value for \"max_allowed_memberships\", must be greater than or equal to 0.")
      end
