...
module Clerk
  class JWKSEd25519PrivateKey
    ...
    def initialize(@kid : String, @alg : String, @use : String, @kty : String, @crv : String, @x : String, @d : String, @x5c : Array(String)?, @x5t : String?, @x5t_s256 : String?, @x5u : String?)
    end
    ...
    def crv=(crv)
      ...
      unless validator.valid?(crv)
        raise ArgumentError.new("invalid value for \"crv\", must be one of #{validator.allowable_values}.")
      end
      @crv = crv
    end
