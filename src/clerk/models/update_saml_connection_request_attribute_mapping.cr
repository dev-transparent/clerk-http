...
module Clerk
  ...
  class UpdateSAMLConnectionRequestAttributeMapping
    ...
    @[JSON::Field(key: "email_address", type: String?, nillable: true, emit_null: false)]
    ...
    def initialize(@user_id : String?, @email_address : String?, @first_name : String?, @last_name : String?)
    end
