...
module Clerk
  ...
  class OrganizationDomain
    ...
    @[JSON::Field(key: "enrollment_mode", type: String, nillable: false, emit_null: false)]
    property enrollment_mode : String

    # Affiliation email address for the domain, if available.
    @[JSON::Field(key: "affiliation_email_address", type: String, nillable: false, emit_null: false)]
    property affiliation_email_address : String

    # Verification details for the domain
    @[JSON::Field(key: "verification", type: OrganizationDomainVerification, nillable: false, emit_null: false)]
    property verification : OrganizationDomainVerification

    # Total number of pending invitations associated with this domain
    @[JSON::Field(key: "total_pending_invitations", type: Int32, nillable: false, emit_null: false)]
    property total_pending_invitations : Int32

    # Total number of pending suggestions associated with this domain
    @[JSON::Field(key: "total_pending_suggestions", type: Int32, nillable: false, emit_null: false)]
    property total_pending_suggestions : Int32
    ...
    def initialize(@object : String, @id : String, @organization_id : String, @name : String, @enrollment_mode : String, @affiliation_email_address : String, @verification : OrganizationDomainVerification, @total_pending_invitations : Int32, @total_pending_suggestions : Int32, @created_at : Int64, @updated_at : Int64)
    end
    ...
    def enrollment_mode=(enrollment_mode)
      ...
      unless validator.valid?(enrollment_mode)
        raise ArgumentError.new("invalid value for \"enrollment_mode\", must be one of #{validator.allowable_values}.")
      end
