...
module Clerk
  class WaitlistEntry
    ...
    @[JSON::Field(key: "is_locked", type: Bool?, nillable: true, emit_null: false)]
    property is_locked : Bool?

    @[JSON::Field(key: "invitation", type: Invitation?, nillable: true, emit_null: false)]
    ...
    def initialize(@object : String, @id : String, @email_address : String, @status : String, @created_at : Int64, @updated_at : Int64, @is_locked : Bool?, @invitation : Invitation?)
    end
