...
module Clerk
  class ModelInstance
    ...
    @[JSON::Field(key: "environment_type", type: String, nillable: false, emit_null: false)]
    property environment_type : String

    @[JSON::Field(key: "allowed_origins", type: Array(String), nillable: false, emit_null: false)]
    ...
    def initialize(@object : String, @id : String, @environment_type : String, @allowed_origins : Array(String))
    end
