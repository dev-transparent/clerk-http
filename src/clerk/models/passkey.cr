...
module Clerk
  class Passkey
    ...
    # Optional properties
    @[JSON::Field(key: "nonce", type: String?, nillable: true, emit_null: false)]
    ...
    def initialize(@status : String, @strategy : String, @attempts : Int32, @expire_at : Int32, @nonce : String?, @message : String?, @verified_at_client : String?)
    end
    ...
    def nonce=(nonce)
      ...
      unless validator.valid?(nonce)
        raise ArgumentError.new("invalid value for \"nonce\", must be one of #{validator.allowable_values}.")
      end
      @nonce = nonce
    end
