...
module Clerk
  class CreatePhoneNumberRequest
    ...
    @[JSON::Field(key: "primary", type: Bool?, nillable: true, emit_null: false)]
    ...
    def initialize(@user_id : String, @phone_number : String, @verified : Bool?, @primary : Bool?, @reserved_for_second_factor : Bool?)
    end
