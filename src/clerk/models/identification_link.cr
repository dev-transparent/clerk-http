...
module Clerk
  class IdentificationLink
    ...
    def initialize(@_type : String, @id : String)
    end
    ...
    def list_invalid_properties
      ...
      if @_type !~ pattern
        invalid_properties.push("invalid value for \"_type\", must conform to the pattern #{pattern}.")
      end
    ...
    def valid?
      return false if @_type !~ Regexp.new(/^oauth_[a-z]+$/)
      true
    end
    ...
    def _type=(_type)
      pattern = Regexp.new(/^oauth_[a-z]+$/)
      if _type !~ pattern
        raise ArgumentError.new("invalid value for \"_type\", must conform to the pattern #{pattern}.")
      end
