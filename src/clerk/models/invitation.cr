...
module Clerk
  class Invitation
    ...
    # Optional properties
    @[JSON::Field(key: "revoked", type: Bool?, nillable: true, emit_null: false)]
    ...
    @[JSON::Field(key: "expires_at", type: Int64?, nillable: true, emit_null: false)]
    ...
    def initialize(@object : String, @id : String, @email_address : String, @public_metadata : Hash(String, Object), @status : String, @created_at : Int64, @updated_at : Int64, @revoked : Bool?, @url : String?, @expires_at : Int64?)
    end
