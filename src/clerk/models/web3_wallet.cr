...
module Clerk
  class Web3Wallet
    ...
    @[JSON::Field(key: "verification", type: Web3WalletVerification, nillable: false, emit_null: false)]
    property verification : Web3WalletVerification
    ...
    def initialize(@object : String, @web3_wallet : String, @verification : Web3WalletVerification, @created_at : Int64, @updated_at : Int64, @id : String?)
    end
